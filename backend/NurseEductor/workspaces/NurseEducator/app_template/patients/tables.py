from .forms import BasePatientForm, BasePatientProgramEnrolmentForm

from ...packages.crud.table.base import ModelTable
from ...packages.crud.table.column import ModelCol


class BasePatientTable(ModelTable):
    ...
    row_actions = [
        {
            ...
            "type": "form",
            "form": BasePatientForm,  # Specify the form to use for editing
    ...
    class Meta:
        model = None
        title = "Add Patient"
        fields = ['id', 'first_name', 'last_name', 'dob', 'age', 'gender', 'email', 'contact_number', 'consent']
...
class BasePatientProgramTable(ModelTable):
    id = ModelCol(display_as='ID', sortable=True, searchable=True)
    ...
    row_actions = [
        {
            ...
            "type": "form",
            "form": BasePatientProgramEnrolmentForm,  # Specify the form to use for editing
            "roles": ["Executive"]  # Specify roles that can perform the action
        }
    ]
