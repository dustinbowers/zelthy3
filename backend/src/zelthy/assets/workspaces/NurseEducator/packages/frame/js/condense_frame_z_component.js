class Frame extends HTMLElement {
  constructor() {
    ...
    const html = `<script defer>
        console.log("Inside Frame Shadow Dom")
    </script>`;
  ...
  connectedCallback() {
    ...
    console.log("theme context", app_theme_config);
    ...
    let config = {
      menu: [
        {
          ...
          <path d="M14.16 7.28C14.16 8.77376 11.92 8.77376 11.92 7.28C11.92 5.78624 14.16 5.78624 14.16 7.28Z" fill="#495057"/>
          <path d="M17.68 6.60127V6.48002C17.68 4.78252 17.0063 3.1549 15.805 1.9549C14.605 0.753656 12.9775 0.079895 11.2799 0.079895H10.1924C10.0199 0.079895 9.8499 0.0798956 9.67989 0.0986456V2.01865C9.84989 2.01865 10.0186 1.99615 10.1924 1.99615H11.2799C12.4686 1.99615 13.6086 2.46866 14.4486 3.30991C15.2886 4.15115 15.7611 5.29115 15.7599 6.47989V7.11989L17.9999 10.9599H15.7599V15.4399H11.9199V19.9199H13.8399V17.3599H15.7599C16.8199 17.3599 17.6799 16.4999 17.6799 15.4399V12.8799H17.9999C18.6849 12.8786 19.3174 12.5112 19.6586 11.9174C19.9999 11.3236 19.9999 10.5936 19.6574 9.99989L17.68 6.60127Z" fill="#495057"/>
          <path d="M5.52 5.2H3.6V8.72H0.079998V10.64H3.6V14.16H5.52V10.64H9.04V8.72H5.52V5.2Z" fill="#495057"/>
        </svg>`,
          name: "Patients",
        },
        {
      ...
      script: "console.log('New scripts')",
      logo: null,
      fav_icon: null,
  ...
  render(config) {
        ...
        <div class="container-fluid d-flex flex-column p-0 vh-100 flex-grow-1" id="frame-container">
            <nav class="d-flex align-items-center justify-content-between frame-navbar">
                ...
                <ul class="dropdown-menu profile-dropdown-menu">
                        ...
                        ? `<li>
                          ...
                          <li>
                              ...
                              ${config?.profile?.roles
                                ?.map(({ url, label }) => {
                                  return `<a class="dropdown-item profile-each-role" href=${url}>
                    ...
                    <li ${
                      config?.display_edit_profile === true
                        ? ""
                        : "style=display:none"
                    }>
                      <button type="button" class="dropdown-item profile-logout" id="open-edit-drawer">
                      <span class="profile-name">Edit</span>
                      </button>
                      </li>
                     
                      <li ${
                        config?.display_change_password === true
                          ? ""
                          : "style=display:none"
                      }>
                          <button type="button" class="dropdown-item profile-logout" id="open-password-drawer">
                              <span class="profile-name">Change Password</span>
                          </button>
                      </li>
                    ...
                    <li>
                        <a class="dropdown-item profile-logout" href="/logout">
          ...
          .then((response) => {
            if (response.ok) {
              response.json().then((res) => {
                console.log("print profile data", res);
    ...
    // shadowRoot
    //   .querySelector("#redirect-to-change-password")
    //   .addEventListener("click", function () {
...
customElements.define("condense-frame", Frame);
